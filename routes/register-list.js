...
//console.log(where)
  ...
  router.post("/add",upload.none(), async (req, res) => {
    ...
    //塞資料第一種用法
    const {lastname, firstname, email, mobile, birthday, account, password, identification, zipcode,address} = req.body;
  ...
  const sql = "INSERT INTO `profile`(`lastname`,`firstname`, `email`, `mobile`, `birthday`, `account`,`password`,`identification`, `zipcode`,`address`,`created_at`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,NOW() )";
  //塞入對應欄位的?值並顯示當前建立時間
